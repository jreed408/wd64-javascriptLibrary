...
function fetchSpace(e) {
    ...
    fetch(baseURL) // starts the process of fetching from our resources
        .then(results => {
            // console.log(results) // show our response
            return results.json() // this method takes in a response (results), reads to completetion and returns the results as a json format
        })
        .then(json => {
            // console.log(json)
            displayRockets(json);
