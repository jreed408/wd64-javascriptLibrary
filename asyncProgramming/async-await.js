...
/*
    - allows is to make a normal function asynchronous. Can us "await"
...
const newFn = () => {
    // await (provides a suntax error because async is not declared)
}
...
fetch('https://random.dog/woof.json')
    ...
    // - Chaining .then() together returns a promise (resole/reject) and is known as method chaining.
