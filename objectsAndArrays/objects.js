...
//? DOT NOTATION
// While we use bracjet notation with arrays, we use something called DOT NOTATION for objects.
...
/*
    ...
    - JSON exists as a string - usefil when you want to fetch data from a server.
...
console.log(Object.keys(spaceJam.toonSquad.tDevil)); // String of index numbers of that string value
...
// We are accessing the keys within our object by a specific name within our square bracket. the key name that is passed needs to be wrapped in quotes as all jeys in an object are strings.
